...
Route::get('employees',[EmployeeController::class,'show'])->name('mostrarEmpleados');

Route::get('employees/{employee}',[EmployeeController::class,'edit'])->name('modificarEmpleado');
Route::delete('employees/{employee}',[EmployeeController::class,'delete'])->name('eliminarEmpleado');
