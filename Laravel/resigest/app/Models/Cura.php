...
class Cura extends Model
{
    ...
    {
        return $this->belongsTo(Empleado::class, 'Id_empleado'); //id se refiere a la clave foránea en la tabla curas-> aparece asi en la bbdd
    }

    public function residente() //una cura pertenece a un empleado en particular
    {
        return $this->belongsTo(Residente::class, 'Id_residente');//id_residente se refiere a la clave foránea de la tabla-> aparece asi en la bbdd
    }
