    ...
    <header class="container-fluid d-flex flex-column justify-content-center"><!--Ocupar todo el ancho disponible-->
        <div class="container"><!--Ocupar 12 columans y centrar-->
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid"><!--Ocupar todo el ancho disponible //////////////////////////////////////// Botones-->
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 ">
                            <li class="nav-item mx-1">
                                <a class="btn btn-outline-dark" href='{{ route('lista.residentes')}}' role="button">Lista de Residentes</a>
                            </li>
                            <li class="nav-item mx-1">
                ...
                <div class="container-fluid"><!--Ocupar todo el ancho disponible //////////////////////////////////////// Botones-->
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 ">
                            ...
                            <li class="nav-item mx-1">
                                <a class="btn btn-outline-dark" href="#" role="button">Gestional Residentes</a>
                            </li>
                            <li class="nav-item mx-1">
