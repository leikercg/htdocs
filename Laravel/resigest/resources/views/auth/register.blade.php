...
@section('content')
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="departamento" class="block mt-1 w-full" type="number" step="1.0" name="departamento" max=7 min=1 :value="old('departamento')" required autocomplete="departamento" />
