 {{-- Formulario de creaciacion y modificación de las tareas --}}
 @extends('master')
     ...
     @isset($tarea->id)
         <div class="row">
             <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                 <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="{{ route('lista.residentes') }}">{{ __('Lista de residentes') }}</a>
                     </li>
                     <li class="breadcrumb-item"><a href="{{ route('ficha.residente', $residente->id) }}">{{ $residente->nombre }}
                             {{ $residente->apellidos }}</a></li>
                     <li class="breadcrumb-item"><a
                             href="{{ route('tareas.residente', ['residente_id' => $residente->id]) }}">{{ __('Tareas') }}</a>
                     </li>
