        ...
        @isset($familiar)<!-- SI ESTA ESTABLECIDO EL FAMILIAR MOSTRAR EL FORMULUARIO DE EDICIÓN, SI NO MOSTRAR EL DE CREACIÓN-->
            ...
            <form action="{{ route('actualizar.familiar', ['id' => $familiar->id]) }}" method="POST">
                ...
                <div class="mt-4">
                    ...
                    <input id="dni" class="block mt-1 w-full" type="text" name="dni" value="{{ $familiar->dni }}"
                        required readonly>
                </div>
                ...
                <div class="mt-4">
                    @foreach ($familiar->residentes as $residente)
                        ...
                        <input id="apellidos" class="block mt-1 w-full" type="text"
                            value="{{ $residente->nombre }} {{ $residente->apellidos }}" required readonly /> <!--No tiene name por que no se envia-->
                        <br>
                    @endforeach
                </div>
                ...
                <div class="mt-4">
                    ...
                    <input type="text" name="departamento" id="departamento" value="{{ $familiar->departamento->nombre }}"
                        readonly>
                </div>
                <br><br>
